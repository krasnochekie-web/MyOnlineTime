...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // === ВОРКЕР ВРЕМЕНИ (ОСТАВЛЯЕМ, он нам нужен) ===
    ...
    public void updateNotificationBadge() {
        ...
        // === ИСПРАВЛЕНИЕ: Если колокольчик скрыт (мы в истории), бейдж тоже умирает! ===
        View bellContainer = findViewById(R.id.header_bell_container);
        if (bellContainer != null && bellContainer.getVisibility() != View.VISIBLE) {
